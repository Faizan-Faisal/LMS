...
class Course_Offerings(Base):
    ...
    course_id = Column(String(20), ForeignKey("courses.course_id", ondelete="RESTRICT", onupdate="CASCADE"), nullable=False)
    section_name = Column(String(255), ForeignKey("sections.section_name", ondelete="RESTRICT", onupdate="CASCADE"), nullable=False)
    instructor_id = Column(String(20), ForeignKey("instructors.instructor_id", ondelete="RESTRICT", onupdate="CASCADE"), nullable=False)
